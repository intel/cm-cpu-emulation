...
SHIM_CALL(clGetExtensionFunctionAddress)(const char *func_name) {
  ...
  //   return
  //   reinterpret_cast<void*>(&SetDefaultResidentGroupAndParallelThreadNum);
  // }
  // if (func_name == "SetResidentGroupAndParallelThreadNumForQueue"sv) {
  //   return
  //   reinterpret_cast<void*>(&SetResidentGroupAndParallelThreadNumForQueue);
  // }
...
SHIM_CALL(clGetExtensionFunctionAddressForPlatform)(
