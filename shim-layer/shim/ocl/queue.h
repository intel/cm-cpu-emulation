...
CL_API_ENTRY CL_API_PREFIX__VERSION_1_2_DEPRECATED cl_command_queue CL_API_CALL
    SHIM_CALL(clCreateCommandQueue)(cl_context context, cl_device_id device,
                                    cl_command_queue_properties properties,
                                    cl_int *errcode_ret)
        CL_API_SUFFIX__VERSION_1_2_DEPRECATED;

CL_API_ENTRY
    cl_command_queue CL_API_CALL SHIM_CALL(clCreateCommandQueueWithProperties)(
...
CL_API_ENTRY cl_int CL_API_CALL SHIM_CALL(clFlush)(
    cl_command_queue command_queue) CL_API_SUFFIX__VERSION_1_0;

CL_API_ENTRY cl_int CL_API_CALL SHIM_CALL(clFinish)(
    cl_command_queue command_queue) CL_API_SUFFIX__VERSION_1_0;
