...
struct Fence : public IntrusiveRefCounter<Fence> {
  Fence(IntrusivePtr<Queue> queue, bool signalled)
      : queue_(queue), signalled_(signalled) {}
...
ZE_APIEXPORT
    ze_result_t ZE_APICALL SHIM_CALL(zeFenceDestroy)(ze_fence_handle_t hFence);
...
ZE_APIEXPORT
    ze_result_t ZE_APICALL SHIM_CALL(zeFenceReset)(ze_fence_handle_t hFence);
} // extern "C"
