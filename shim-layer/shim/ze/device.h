...
ZE_APIEXPORT
    ze_result_t ZE_APICALL SHIM_CALL(zeDeviceGetCommandQueueGroupProperties)(
        ze_device_handle_t hDevice, uint32_t *pCount,
...
ZE_APIEXPORT
    ze_result_t ZE_APICALL SHIM_CALL(zeDeviceGetMemoryAccessProperties)(
        ze_device_handle_t hDevice,
...
ZE_APIEXPORT
    ze_result_t ZE_APICALL SHIM_CALL(zeDeviceGetExternalMemoryProperties)(
        ze_device_handle_t hDevice,
